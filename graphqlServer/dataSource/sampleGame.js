module.exports = {
  ...
  assets: {
    thumbnail:
      'https://cf.geekdo-images.com/thumb/img/5P9XdMqgHu8f56SlenLalqSK_GU=/fit-in/200x150/pic3763556.jpg',
    image:
  ...
  families: ['Solitaire Games', 'Tableau Building', 'Terra Mystica'],
  implementations: ['Terra Mystica'],
  ...
  ranks: [
    {
      ...
      value: '7',
      averageRating: '8.13013'
    },
    {
      name: 'strategygames',
      friendlyName: 'Strategy Game Rank',
      value: '5',
      averageRating: '8.21755'
    }
  ],
  weight: {
    average: '4.2842',
  ...
  meta: {
    fetchedAt: new Date('2019-07-25T05:23:45.817Z')
  }
};
